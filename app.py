...
for coin in coins:
    data = yf.download(coin, start="2022-01-01", auto_adjust=True, interval="1d")
...
try:
    ...
    market_df.columns = ["Coin", "Symbol", "Price", "Market Cap", "Volume", "24h Change %"]
...
# -----------------------------
st.header("Simulation (Coming Soon)")
st.write("Simulation for next 7 days will appear here once streaming data services are enabled.")
